...
const Header = () => {
  return (
    <div className="flex justify-between items-center w-full my-2 bg-[rgba(206, 217, 217, 0.8)] ">
      ...
      <div className="flex justify-end w-full gap-3 ">
        ...
        <a
          className="flex py-[10px] px-[24px] items-center rounded-3xl bg-[#DDE4E4] text-[#0D7373] text-[14px] font-bold gap-2"
        ...
        <div className="rounded-full bg-[#DDE4E4] p-[8px]">
          <CiSettings size={24} />
        </div>
